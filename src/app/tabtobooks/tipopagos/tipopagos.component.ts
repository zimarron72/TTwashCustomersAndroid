...
async aviso(header : string, mensaje : string, code : string) {
  ...
  async ionViewWillEnter() {
    ...
    var url = 'https://washtt.com/v1_api_clientes_getpaysclientes.php'
    ...
    this.cHttps(url, data1).subscribe(
      async (res: any) => {
        ...
        switch (res.data.respuesta) {
          ...
          case '200_OK':
            this.inview = res.data.enrevision
            this.admitted = res.data.aceptados
            this.reject = res.data.negados
    ...
    this.cHttps(url, data1).subscribe(
      async (res: any) => {
        ...
        switch (res.data.respuesta) {
          ...
          case '200_OK':
             this.inview = res.data.sinconfirmar
            this.admitted = res.data.confirmados
            this.reject = res.data.completados
           break;
